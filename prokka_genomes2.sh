...
prokka_data(){
    ...
    if [[ ! -e $prokkaoutput/$str2 ]]; then
        ...
        singularity exec prokka.sif prokka --norrna --notrna --centre X --compliant --kingdom $kingdom $genome_file2 --prefix $str2 --outdir $prokkaoutput/$str2 #--prefix $prokkaoutput/$str2 
